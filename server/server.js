...
const DEFAULT_PACKAGES = [
  { id: 'bronze', name: 'الباقة البرونزية', price: 199, billing: 'monthly', order: 1, active: true,
    desc: 'الأساسيات: متابعة الأطفال والاشتراكات والفواتير',
    maxBranches: 1, maxChildren: 60, maxUsers: 5,
    features: ['children','subscriptions','attendance','sales','taxInvoices','cashClosing','reports','settings'] },
  { id: 'silver', name: 'الباقة الفضية', price: 349, billing: 'monthly', order: 2, active: true,
    desc: 'تضيف التواصل مع الأسر والمصروفات وملاحظات الطلاب',
    maxBranches: 2, maxChildren: 150, maxUsers: 12,
    features: ['children','subscriptions','attendance','childNotes','sales','expenses','taxInvoices','cashClosing','branchTasks','reports','messages','whatsapp','users','settings'] },
  { id: 'gold', name: 'الباقة الذهبية', price: 599, billing: 'monthly', order: 3, active: true, highlight: true,
    desc: 'تضيف مكتبة الأنشطة والمحاسبة والإقفال الشهري',
    maxBranches: 4, maxChildren: 400, maxUsers: 30,
    features: ['children','subscriptions','attendance','childNotes','activities','sales','expenses','accounting','taxInvoices','cashClosing','monthlyClose','branchTasks','reports','branchReport','messages','tasks','whatsapp','users','branches','settings'] },
  { id: 'platinum', name: 'الباقة البلاتينية', price: 899, billing: 'monthly', order: 4, active: true,
    desc: 'كل خدمات المنصة: الموارد البشرية والوثائق الحكومية وفروع بلا حد',
